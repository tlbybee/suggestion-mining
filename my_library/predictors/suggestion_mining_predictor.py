...
def main():
    ...
    # l = SuggestionMiningPredictor.load_line("/Users/faraz/MCS/Forum-Data-Mining/data/test.csv")
    # s = "This would enable live traffic aware apps."
    # smp = SuggestionMiningPredictor()
    # out = smp.line_to_dict(s)
    pred = Predictor.from_path("/Users/faraz/MCS/Forum-Data-Mining/ser_dir/model.tar.gz")

    results = pred.predict(sentence="This would enable live traffic aware apps.")
